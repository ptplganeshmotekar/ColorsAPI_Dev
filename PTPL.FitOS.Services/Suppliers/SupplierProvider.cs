...
{
    /// <summary>
    /// This service class is use for supplier related services.
    /// </summary>
    public class SupplierProvider : ISupplierInterface
    {
        #region Fields      
        ...
        /// </summary>
        public SupplierProvider(IHttpClientFactory httpClientFactory, IConfiguration configuration)
        {                      
        ...
        public async Task<object> CheckSupplierColours(List<string> colIds,string token, CancellationToken ct = default)
        {
            try
            {
                dynamic result = await Common.HttpRequestAsyncCalls(colIds, token, _httpClientFactory, "SupplierAPIs", "Suppliers/CheckSupplierColours", "Post");
