...
{
    /// <summary>
    /// This service class is use for style related services.
    /// </summary>
    public class StyleProvider : IStyleInterface
    {
        #region Fields      
        ...
        /// </summary>
        public StyleProvider(IHttpClientFactory httpClientFactory, IConfiguration configuration)
        {                     
        ...
        public async Task<object> CheckStyleColourways(List<string> colIds, string token, CancellationToken ct = default)
        {
            try
            {
                dynamic result = await Common.HttpRequestAsyncCalls(colIds, token, _httpClientFactory, "StyleAPIs", "Styles/CheckStyleColourways", "Post");
